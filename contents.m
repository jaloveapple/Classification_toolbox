...
%		Deterministic_annealing - Compute k features which typify the data using the Deterministic SA algorithm
%		Deterministic_SA    - Compute k features which typify the data using the Deterministic SA algorithm (Another implementation)
...
%		Stochastic_SA       - Compute k features which typify the data using the Stochastic SA algorithm
%
...
%       Voted perceptron            - Voted perceptron algorithm.
%
% Feature selection
%
...
%		infomat						- Generates the mutual information matrix. Used by Koller	
%		Koller						- Choose the most relevant features using the Koller-Sawami algorithm
...
%
% Data sets (Ending _data means that the file contains features, 
